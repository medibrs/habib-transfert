    ...
    <div style={{ paddingTop: "clamp(120px, 16vw, 160px)", paddingBottom: "clamp(48px, 8vw, 80px)", background: "var(--cream)" }}>
      <div className="container-main" style={{ maxWidth: "896px" }}>
        ...
        <div className="space-y-6" style={{ color: "var(--slate)", lineHeight: "1.75" }}>
          ...
          <p>HB Drivers 06<br/>Nice, Côte d&apos;Azur, France<br/>Téléphone : +33 7 84 70 34 56<br/>Email : Hbdrivers06@outlook.it</p>
          ...
          <p>HB Drivers 06 s&apos;efforce d&apos;assurer l&apos;exactitude des informations diffusées sur ce site. Toutefois, elle ne peut garantir l&apos;exactitude, la complétude et l&apos;actualité des informations.</p>
        </div>
      </div>
    </div>
  );
